...
- Desenvolvimento de sites institucionais responsivos <br>
- Implementação de funcionalidades em sistema ERP <br>
- Atuação no front-end e back-end <br>
- Criação de regras de negócio e scripts <br>
...
<a href="mailto:ramonfernandescabral@gmail.com" target="_blank">
